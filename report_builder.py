...
def generate_pdf_bytes(
    ...
    story.append(
        Paragraph(
            ...
            "• Impact – what a potential failed test might lead to<br/>"
            "• Example – more specific cyberattack technique that could be faced and/or example of financial impact<br/>"
            "• Data privacy and protection – reference to United Kingdom and European Union General Data Protection Regulations "
            "(UK and EU GDPR) and California Consumer Privacy Act (CCPA)<br/>"
            "• Potential Resolution – action that may be considered to reduce the risk<br/>"
            "• Resolution risk – impact that may need to be considered as a result of implementing action to reduce the risk<br/>"
            "• To pass our test – criteria that we have set to pass the test<br/>"
            "• Key metric / perspective – insight on how wide-spread the risk may be.<br/><br/>"

            "<b>1. Account compromise</b><br/>"
            ...
            "on multiple websites, data breaches often involve this type of attack<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – change password (wherever it is used), use unique / strong passwords, enable "
            "multi-factor authentication (MFA), change answers to any security questions<br/>"
            "• Resolution risk – new password may be forgotten and/or MFA may not be strong enough (consider using a password "
            "manager and Google / Microsoft authenticator)<br/>"
            "• To pass our test - your email address must not show in a list of known compromised accounts from a dark web search<br/>"
            "• Key metric / perspective – Over 14 billion email accounts appear in this test based on our (external) 2024 data source.<br/><br/>"

            "<b>2. Email anti-spoofing protection</b><br/>"
            "• Impact – other people may be sending email that appears to be from you<br/>"
            "• Example – ‘spoofing’ is a technique used by bad actors, where emails are sent that impersonate company employees, "
            "financial implications can often be experienced from this type of attack<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – review and update configuration settings on your DNS and email platforms<br/>"
            "• Resolution risk – failed email delivery due to strict policy enforcement changes<br/>"
            "• To pass our test – your email platform must have a strong Domain Based Message Authentication Reporting and "
            "Conformance (DMARC) policy in place (set to quarantine or reject) and no errors in Sender Policy Framework (SPF) settings<br/>"
            "• Key metric / perspective – Approximately 45% of domains should pass this test based on our (external) 2024 data source.<br/><br/>"

            "<b>3. Email encryption (privacy)</b><br/>"
            "• Potential Impact – other people may be reading the emails that you send and receive<br/>"
            "• Example – ‘man-in the-middle’ attack is a technique used by bad actors, where they read and potentially alter communications<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – review and update configuration settings on your email platform<br/>"
            "• Resolution risk – failed email delivery due to compatibility and/or configuration<br/>"
            "• To pass our test – an up-to-date version of Transport Layer Security (TLS) must be detected on your email platform<br/>"
            ...
            "<b>4. Email encryption downgrade (privacy)</b><br/>"
            "• Potential Impact – other people may be reading the emails that you send and receive<br/>"
            "• Example – ‘man-in-the-middle’ attack is a technique used by bad actors, where they read and potentially alter communications<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – review and update configuration settings on your email hosting platform<br/>"
            "• Resolution risk – failed email delivery due to compatibility and/or configuration<br/>"
            "• To pass our test – Your email platform must have Mail Transfer Agent-Strict Transport Security (MTA-SPS) settings "
            "applied to enforce mode and no errors<br/>"
            "• Key metric / perspective – Approximately 1% of domains should pass this test based on our (external) 2024 data source.<br/><br/>"

            "<b>5. Public IP address vulnerability</b><br/>"
            "• Potential Impact – systems weaknesses could be exploited, leading to data compromise<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – review, remove and/or block access to known weaknesses that are associated with your public IP address<br/>"
            "• Resolution risk – service disruption, misconfiguration and compatibility issues on hosts that have been changed<br/>"
            "• To pass our test – no vulnerabilities must be detected on your public IP address<br/>"
            ...
            "<b>6. Website malicious software</b><br/>"
            "• Potential Impact – your website may be infected with malicious software<br/>"
            "• Example – ‘drive by downloads’ are a type of attack used by bad actors, whereby user devices are infected simply by visiting the site<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – isolate, clean, recover and secure your web server<br/>"
            "• Resolution risk – service disruption, misconfiguration and compatibility issues on website due to change<br/>"
            "• To pass our test – your website must not have malware detected by scanners<br/>"
            "• Key metric / perspective – Approximately 93% of websites should pass this test based on our (external) 2024 data source.<br/><br/>"

            "<b>7. Website blacklisting</b><br/>"
            "• Potential Impact – your website may be infected with malicious software<br/>"
            "• Example – ‘website blacklisting’ can lead to websites being blocked by search engines and security tools<br/>"
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – isolate, clean, recover and secure your web server and request removal from blacklist<br/>"
            "• Resolution risk – service disruption, misconfiguration and compatibility issues on website due to change<br/>"
            "• To pass our test – your website must not appear on a blacklist site lists<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website has strong encryption in place<br/>"
            "• Resolution risk – service disruption, misconfiguration and compatibility issues on website due to change<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website has an appropriate privacy policy<br/>"
            "• Resolution risk – legal considerations for content of notice<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website has an appropriate cookies policy<br/>"
            "• Resolution risk – challenges with technical review of cookies and legal considerations for content of notice<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website has an appropriate banner or button to reject non-essential cookies<br/>"
            "• Resolution risk – challenges with implementation, reduced analytics and change in user experience<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website is protected by a web application firewall<br/>"
            "• Resolution risk – impact to website performance, configuration complexity and cost<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – ensure your website has protections to prevent exploitation<br/>"
            "• Resolution risk – configuration complexity and cost<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/>"
            "• Potential resolution – check and pay the ICO annual fee<br/>"
            "• Resolution risk – cost to implement<br/>"
            "• To pass our test – your business name must be visible via the register of data protection fee payers<br/>"
            "• Key metric / perspective – Approximately 80% of business should pass this test based on our (external) 2024 data source.",
            styles["Body"],
        )
    )
    story.append(PageBreak())
