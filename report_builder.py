...
def generate_pdf_bytes(
    ...
    story.append(
        Paragraph(
            ...
            "• Key metric / perspective – insight on how wide-spread the risk may be.<br/>"
            ...
            "• Data privacy and protection – potential for unauthorised access to personal data and therefore non-compliance "
            "with UK GDPR, EU GDPR and CCPA<br/><br/><br/>"
            "• Potential resolution – isolate, clean, recover and secure your web server and request removal from blacklist<br/><br/><br/>"
            "• Resolution risk – service disruption, misconfiguration and compatibility issues on website due to change<br/>"
